CLASS zad_cl_read_so_compile_excel DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zad_cl_read_so_compile_excel IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
     ...
     TRY.
      ...
      ENTITY salesorderitempartner
        FROM VALUE #( ( %key = VALUE #( SalesOrderItem  = '000010'
                                        partnerfunction = 'WE' ) ) )
    ...
    " Generate the XLSX report.
     ...
     DATA(lv_timestamp_minus_24_hour) = utclong_add(
      ...
      zad_cl_read_so_compile_excel=>report = VALUE #(
