CLASS zad_cl_apj_buslogic_reuse_comp DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zad_cl_apj_buslogic_reuse_comp IMPLEMENTATION.
     ...
     DATA(lv_timestamp_minus_24_hour) = utclong_add(
       ...
       " Writer the header of the worksheet
        ...
        LOOP AT lt_logs INTO DATA(lo_log).
          ...
          DATA(lv_time) = lo_header->log_timestamp.
         ...
         "Write the header information
             ...
             "Write the object
              ...
              lo_cursor->move_left( )->move_left( )->move_left( )->move_left( ).
              ...
              loop at lt_items into data(ls_item).
                ...
                "Write the log item number
                    lo_cursor->move_down( )->move_left( )->get_cell( )->value->write_from( 'Log Item Number:' ).
                    lo_cursor->move_right( )->get_cell( )->value->write_from( ls_item-log_item_number ).

                "Write the message text
                    lo_cursor->move_down( )->move_left( )->get_cell( )->value->write_from( 'Message Text' ).
                    lo_cursor->move_right( )->get_cell( )->value->write_from( ls_item-item->get_message_text( ) ).

                    lo_cursor->move_left( )->move_left( ).
      ...
      zad_cl_apj_buslogic_reuse_comp=>report = VALUE #(
