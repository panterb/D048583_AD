CLASS zad_cl_apj_shop_online_jobtemp DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZAD_CL_APJ_SHOP_ONLINE_JOBTEMP IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    ...
    CONSTANTS lc_catalog_name      TYPE cl_apj_dt_create_content=>ty_catalog_name  VALUE 'ZAD_CAT_EXCEL_WRITE_SEND_EMAIL'.
    CONSTANTS lc_catalog_text      TYPE cl_apj_dt_create_content=>ty_text          VALUE 'Job Catalog for writing excel and sending email'.
    CONSTANTS lc_class_name        TYPE cl_apj_dt_create_content=>ty_class_name    VALUE 'zad_cl_apj_buslogic_reuse_comp'.

    CONSTANTS lc_template_name     TYPE cl_apj_dt_create_content=>ty_template_name VALUE 'ZAD_TEMP_EXCEL_WRITE_SEND_EMAIL'.
    CONSTANTS lc_template_text     TYPE cl_apj_dt_create_content=>ty_text          VALUE 'Job Template for writing excel and sending email'.

    CONSTANTS lc_transport_request TYPE cl_apj_dt_create_content=>ty_transport_request VALUE 'XJDK901124'.
    CONSTANTS lc_package           TYPE cl_apj_dt_create_content=>ty_package           VALUE 'Z_AD_GENERATE_EXCEL_SEND_MAIL'.
